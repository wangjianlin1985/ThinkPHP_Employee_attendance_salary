...
<script>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="salaryQueryForm" id="salaryQueryForm" action="<?php echo url('Salary/empFrontlist'); ?>" class="mar_t15" method="post">
			<div class="form-group">
