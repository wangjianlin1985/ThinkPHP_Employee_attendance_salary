...
<script>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="kaoheQueryForm" id="kaoheQueryForm" action="<?php echo url('Kaohe/empFrontlist'); ?>" class="mar_t15" method="post">
            <div class="form-group" styel="display:none;">
