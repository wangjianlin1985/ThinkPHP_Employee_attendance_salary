...
<div class="container">
	<ul class="breadcrumb">
  		...
  		<li><a href="<?php echo url('Kaoqin/frontlist'); ?>">员工考勤信息</a></li>
  		<li class="active">详情查看</li>
	</ul>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">考勤id:</div>
		<div class="col-md-10 col-xs-6"><?php echo $kaoqin['kaoqinId']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">姓名:</div>
		<div class="col-md-10 col-xs-6"><?php echo $kaoqin['xingmingF']['xingming']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">性别:</div>
		<div class="col-md-10 col-xs-6"><?php echo $kaoqin['xingbie']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">所属部门:</div>
		<div class="col-md-10 col-xs-6"><?php echo $kaoqin['suoshubumenF']['bumenmingcheng']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">担任职务:</div>
		<div class="col-md-10 col-xs-6"><?php echo $kaoqin['danrenzhiwu']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">年份:</div>
		<div class="col-md-10 col-xs-6"><?php echo $kaoqin['nianfen']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">月份:</div>
		<div class="col-md-10 col-xs-6"><?php echo $kaoqin['yuefen']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">到勤天数:</div>
		<div class="col-md-10 col-xs-6"><?php echo $kaoqin['daoqintianshu']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">迟到天数:</div>
		<div class="col-md-10 col-xs-6"><?php echo $kaoqin['chidaotianshu']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">旷工天数:</div>
		<div class="col-md-10 col-xs-6"><?php echo $kaoqin['kuangdaotianshu']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">请假天数:</div>
		<div class="col-md-10 col-xs-6"><?php echo $kaoqin['qingjiatianshu']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">备注:</div>
		<div class="col-md-10 col-xs-6"><?php echo $kaoqin['beizhu']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">添加时间:</div>
		<div class="col-md-10 col-xs-6"><?php echo $kaoqin['addtime']; ?></div>
	</div>
	<div class="row bottom15">
