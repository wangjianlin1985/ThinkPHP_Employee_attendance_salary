...
<script>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="diaodongQueryForm" id="diaodongQueryForm" action="<?php echo url('Diaodong/empFrontlist'); ?>" class="mar_t15" method="post">
